- name: kubernetes.user-authz.deprecated-spec
  ...
  - alert: UserAuthzDeprecatedCARSpec
    ...
    annotations:
      description: |-
        There is a cluster authorization rule with [deprecated]("after rebase there will be a proper link") spec parameters - either 'spec.limitNamespaces' or 'spec.AllowAccessToSystemNamespaces', or both. Migrate to '.spec.namespaceSelector'.
